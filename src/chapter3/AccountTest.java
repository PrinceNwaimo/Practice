...
public class AccountTest {
    public static void main(String[] args) {
       ...
       double withdrawalAmount= input.nextDouble();
        System.out.printf("%n subtracting %.2f to account1 balance%n%n",withdrawalAmount);
        ...
        System.out.printf("%n subtracting %.2f to account2 balance%n%n",withdrawalAmount);
